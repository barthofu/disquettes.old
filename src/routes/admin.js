...
router
	...
	.get("/overview", authLoggedIn(), getStats, (req, res) =>
		res.render("admin/layout", { page: "overview", stats: req.args })
	)
	.get("/list", authLoggedIn(), (req, res) =>
		res.render("admin/layout", { page: "list" })
	)
	.get("/waiting", authLoggedIn(), showWaiting)

	.get("/submit", authLoggedIn(), (req, res) =>
		res.render("admin/layout", { page: "submit" })
	)
